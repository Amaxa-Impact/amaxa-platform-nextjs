  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        isActive ? 'data-active:text-foreground' : 'text-muted-foreground',
...
function RouterTabsPanel({ className, ...props }: TabsPrimitive.Panel.Props) {
...
export {
  Tabs,
  TabsList,
  RouterTab as TabsTab,
  RouterTab as TabsTrigger,
  RouterTabsPanel as TabsPanel,
  RouterTabsPanel as TabsContent,
};
